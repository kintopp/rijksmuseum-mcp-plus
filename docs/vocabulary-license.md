...
3 distinct license designations across 831,339 artworks.

| Value | Rights URI | Artworks |
|---|---|---|
| `publicdomain` | `http://creativecommons.org/publicdomain/mark/1.0/` | 728,277 |
| `InC` | `http://rightsstatements.org/vocab/InC/1.0/` | 101,334 |
