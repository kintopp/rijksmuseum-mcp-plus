...
| `collection_stats` | Aggregate statistics, counts, and distributions across any dimension (artwork or provenance). Returns formatted text tables. Artwork dimensions: type, material, technique, creator, century, decade, etc. Provenance dimensions: transferType, party, location, decade, etc. All filters combine freely. |
