...
| `browse_set` | Browse artworks in a curated set. DB-backed: returns DB-direct records with object numbers, titles, creators, dates, descriptions, dimensions, image/IIIF URLs, and a stable lodUri. Pagination via resumption token. |
