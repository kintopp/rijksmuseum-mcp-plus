...
--     Manual one-off: kept as position_method='llm_enrichment' (NOT 'rule:missing_receiver')
--     because it is NOT regenerated by writeback-missing-receivers — the plan-015 §G
--     snapshot trigger ('llm_enrichment'/'llm_disambiguation') must still capture it.
