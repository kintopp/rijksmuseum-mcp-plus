...
section("1. tools --json");
{
  ...
  assert(Array.isArray(tools) && tools.length === 15, `15 in-scope tools (got ${tools.length})`);
...
section("9. tools --compact");
{
  ...
  assert(Array.isArray(manifest) && manifest.length === 15, `15 in-scope tools (got ${manifest.length})`);
