...
// All 17 tools registered with ENABLE_FIND_SIMILAR=true: 14 standard
// (incl. find_similar + search_inscriptions + get_conservation_history) + 3 app (get_artwork_image,
