...
EXPECTATIONS: list[AuditTarget] = [
    ...
    AuditTarget(
        ...
        min_rows=8000,
        max_rows=20000,
        rationale="#220 smoke test: 100 exhibitions → 1,285 members; extrapolate ~11k for 870",
    ),
    AuditTarget(
        ...
        min_rows=180000,
        max_rows=250000,
        rationale="v0.24=195,455; v23.1=194,074. Stable ±2%",
    ),
    ...
    AuditTarget(
        ...
        min_rows=8000,
        max_rows=20000,
        rationale="Junction of artworks ∩ exhibition_members; downstream of #220",
    ),
    AuditTarget(
    ...
    AuditTarget(
        ...
        min_rows=10000,
        max_rows=100000,
        rationale="Plan estimate 55-70k; range wide because no real data yet",
    ),
    AuditTarget(
    ...
    AuditTarget(
        ...
        min_rows=2_000_000,
        max_rows=6_000_000,
        rationale="Plan estimate 3-5M (most artworks have ≥2 title variants)",
    ),
    AuditTarget(
