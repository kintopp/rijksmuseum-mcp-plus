...
def build_steps(db: Path, dry_run: bool) -> list[dict]:
    ...
    base = [
        ...
        },
        {
            "id": 2,
            "label": "batch_geocode",
            "script": REPO_ROOT / "scripts/batch_geocode.py",
            "argv": ["--db", db_arg],
            "supports_dry_run": True,
            "writes_coords": True,
        },
        {
            ...
            "script": REPO_ROOT / "scripts/geocode_places.py",
        ...
        },
        {
            ...
            "script": REPO_ROOT / "scripts/backfill_coord_method_authority.py",
...
def run_preflight(log_dir: Path, master_log) -> int:
    ...
    cmd = [PYTHON, str(REPO_ROOT / "scripts/preflight_regeo.py"), "--skip-live-api"]
