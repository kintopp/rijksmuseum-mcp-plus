...
Full details are documented in [metadata categories](/docs/metadata-categories.md) (fields returned by `get_artwork_details`) and [search parameters](/docs/search-parameters.md) (all `search_artwork` filters).
