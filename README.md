...
| `narrative` | Curatorial narrative (museum wall text). Classified under [AAT 300048722](http://vocab.getty.edu/aat/300048722) (essays).  | Full-text search across ~14K artworks with curatorial narratives. Harvested from the Linked Art `subject_of` field — distinct from the Search API's `description` parameter (AAT 300435452), which queries a different, broader text field via `referred_to_by`. These are interpretive, art-historical texts written by museum curators — equivalent to the wall labels in the galleries. Available in English and/or Dutch. |
