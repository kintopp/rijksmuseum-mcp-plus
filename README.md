...
Recent ([v0.20](https://github.com/kintopp/rijksmuseum-mcp-plus/releases/tag/v0.20)):
  ...
  - Search by creator gender, birth year range, and attribution qualifier (e.g. "paintings by women artists born in the
  19th century", "works from Rembrandt's workshop")
